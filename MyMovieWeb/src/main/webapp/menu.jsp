  ...
  <div class="container ">  
   <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">  
      ...
      <c:when test="${empty sessionId}">
        ...
        <li class="nav-item"><a href="<c:url value="/books.jsp"/>" class="nav-link" >영화목록</a></li>
        <li class ="nav-item"><a href = "<c:url value="/addBook.jsp"/>" class = "nav-link"  >영화등록</a></li>
        <li class ="nav-item"><a href = "<c:url value="/editBook.jsp?edit=update"/>" class = "nav-link"  >영화수정</a></li>
        <li class ="nav-item"><a href = "<c:url value="/editBook.jsp?edit=delete"/>" class = "nav-link"  >영화삭제</a></li>
